...
class Agent extends MobileDetect
{
    ...
    {
        return $this->retrieveUsingCacheOrResolve('afterburner.platform', function () {
    ...
    {
        return $this->retrieveUsingCacheOrResolve('afterburner.browser', function () {
            return $this->findDetectionRulesAgainstUserAgent(
    ...
    {
        return $this->retrieveUsingCacheOrResolve('afterburner.desktop', function () {
