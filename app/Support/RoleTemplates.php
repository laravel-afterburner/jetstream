...
class RoleTemplates
{
    ...
    protected static function team(): array
    {
        return [
            ...
            'permission_map' => [
                'team_lead' => ['manage_users', 'manage_team_settings', 'manage_meetings', 'view_financials', 'manage_budgets', 'vote_resolutions', 'view_documents', 'create_documents', 'edit_documents', 'delete_documents', 'download_documents', 'share_documents', 'manage_document_permissions', 'view_document_versions', 'restore_document_versions', 'manage_folders', 'manage_folder_permissions', 'manage_retention_tags'],
                'coordinator' => ['manage_meetings', 'view_documents', 'create_documents', 'edit_documents', 'download_documents', 'manage_folders', 'view_document_versions'],
                'treasurer' => ['manage_meetings', 'view_financials', 'manage_budgets', 'view_documents', 'create_documents', 'edit_documents', 'download_documents', 'view_document_versions'],
    ...
    protected static function company(): array
    {
        return [
            ...
            'permission_map' => [
                'owner_manager' => ['manage_users', 'manage_team_settings', 'view_financials', 'manage_budgets', 'approve_expenses', 'assign_tasks', 'view_reports', 'view_documents', 'create_documents', 'edit_documents', 'delete_documents', 'download_documents', 'share_documents', 'manage_document_permissions', 'view_document_versions', 'restore_document_versions', 'manage_folders', 'manage_folder_permissions', 'manage_retention_tags', 'view_audit_log'],
                'supervisor' => ['assign_tasks', 'view_reports', 'view_documents', 'create_documents', 'edit_documents', 'download_documents', 'manage_folders', 'view_document_versions'],
                'department_lead' => ['manage_users', 'view_financials', 'manage_budgets', 'approve_expenses', 'assign_tasks', 'view_reports', 'view_documents', 'create_documents', 'edit_documents', 'delete_documents', 'download_documents', 'manage_folders', 'manage_folder_permissions', 'manage_retention_tags', 'view_document_versions'],
                'senior_staff' => ['assign_tasks', 'view_reports', 'view_documents', 'create_documents', 'edit_documents', 'download_documents', 'view_document_versions'],
        ...
        return [
            'roles' => [
                ...
                [
                    'name' => 'Vice President',
                    'slug' => 'vice_president',
                    'description' => 'Acts for the president when absent',
                    'is_default' => false,
                    'hierarchy' => 2,
                    'badge_color' => 'amber',
                    'max_members' => 1,
            ...
            'permission_map' => [
                ...
                'vice_president' => ['vote_resolutions', 'create_resolutions', 'view_ballot_results', 'view_documents', 'download_documents', 'view_document_versions'],
                'treasurer' => ['manage_meetings', 'view_financials', 'manage_budgets', 'vote_resolutions', 'view_ballot_results', 'view_documents', 'create_documents', 'edit_documents', 'download_documents', 'view_document_versions'],
                'secretary' => ['manage_properties', 'manage_meetings', 'view_financials', 'vote_resolutions', 'create_resolutions', 'manage_ballots', 'view_ballot_results', 'manage_proxy_votes', 'export_ballot_results', 'view_documents', 'create_documents', 'edit_documents', 'delete_documents', 'download_documents', 'share_documents', 'manage_document_permissions', 'view_document_versions', 'restore_document_versions', 'manage_folders', 'manage_folder_permissions', 'manage_retention_tags'],
                'council_member' => ['vote_resolutions', 'create_resolutions', 'view_ballot_results', 'view_documents', 'download_documents', 'view_document_versions'],
    ...
    protected static function organization(): array
    {
        return [
            ...
            'permission_map' => [
                'executive_director' => ['manage_users', 'manage_team_settings', 'manage_meetings', 'view_financials', 'manage_budgets', 'manage_programs', 'vote_resolutions', 'create_resolutions', 'view_documents', 'create_documents', 'edit_documents', 'delete_documents', 'download_documents', 'share_documents', 'manage_document_permissions', 'view_document_versions', 'restore_document_versions', 'manage_folders', 'manage_folder_permissions', 'manage_retention_tags', 'view_reports', 'view_audit_log'],
                'program_manager' => ['manage_meetings', 'view_financials', 'manage_programs', 'view_documents', 'create_documents', 'edit_documents', 'download_documents', 'manage_folders', 'view_document_versions', 'view_reports'],
                'coordinator' => ['manage_meetings', 'manage_programs', 'view_documents', 'create_documents', 'edit_documents', 'download_documents', 'manage_folders'],
                'board_member' => ['view_financials', 'vote_resolutions', 'create_resolutions', 'view_documents', 'download_documents', 'view_document_versions', 'view_reports'],
                'member' => ['vote_resolutions', 'view_documents', 'download_documents', 'view_document_versions'],
            ],
        ];
    }
