 ...
 * 
 * NOTE: API features are currently DISABLED in config/afterburner.php
 * (Features::api() is commented out).
 * 
 * This component uses stub methods in Afterburner class:
 * - Afterburner::hasPermissions() - always returns false
 * - Afterburner::validPermissions() - always returns empty array
 * - Afterburner::$permissions - empty array
 * 
 * See Afterburner::class for detailed notes on what needs to be implemented
 * if API features are enabled in the future.
 */
class ApiTokenManager extends Component
{
    ...
    {
        $this->createApiTokenForm['permissions'] = Afterburner::$defaultPermissions;
    }
    ...
    public function createApiToken()
    {
        ...
        $this->displayTokenValue($this->user->createToken(
            ...
            Afterburner::validPermissions($this->createApiTokenForm['permissions'])
        ));
    ...
    public function updateApiToken()
    {
        $this->managingPermissionsFor->forceFill([
            'abilities' => Afterburner::validPermissions($this->updateApiTokenForm['permissions']),
        ])->save();
