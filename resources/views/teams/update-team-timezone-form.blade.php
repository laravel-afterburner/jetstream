<x-form-section submit="updateTimezone">
    ...
    <x-slot name="description">
        @if (Gate::check('update', $team))
            {{ __('Update the :entity timezone so that :entity related dates and times will be displayed in the appropriate timezone.', ['entity' => entity_label()]) }}
        @else
            {{ __(':entity related dates and times will be displayed in the appropriate timezone.', ['entity' => entity_label()]) }}
        @endif
    </x-slot>
    ...
    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            ...
            @if($savedTimezone)
                <div class="{{ Gate::check('update', $team) ? 'mt-3' : '' }} space-y-2">
