                ...
                <div class="flex flex-wrap items-start justify-between gap-3">
                    ...
                    @if ($canManageAgenda || $item->referenceViewUrl())
                        <div class="flex flex-wrap items-center gap-2 shrink-0">
                            ...
                            @if ($canManageAgenda)
                            <button type="button"
                                    wire:click="moveAgendaItem({{ $item->id }}, 'up')"
                                    @disabled($index === 0)
                                    class="p-1 text-gray-400 hover:text-gray-600 disabled:opacity-30 dark:hover:text-gray-300 rounded"
                                    title="Move up">
                            ...
                            <button type="button"
                                    wire:click="moveAgendaItem({{ $item->id }}, 'down')"
