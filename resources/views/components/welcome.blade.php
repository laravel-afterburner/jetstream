...
{{ $slot ?? '' }}
    ...
    <div class="mt-8 divide-y divide-gray-200 overflow-hidden rounded-lg bg-gray-200 shadow dark:divide-gray-700 dark:bg-gray-700 sm:grid sm:grid-cols-2 sm:gap-px sm:divide-y-0">
      
      <div class="group relative rounded-tl-lg rounded-tr-lg border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600 sm:rounded-tr-none sm:even:border-l sm:even:[&:not(:last-child)]:border-b sm:odd:[&:not(nth-last-2)]:border-b">
        <div>
          <span class="inline-flex rounded-lg bg-teal-50 p-3 text-teal-700 dark:bg-teal-900/30 dark:text-teal-300">
      ...
      <div class="group relative border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600 sm:rounded-tr-lg sm:even:border-l sm:even:[&:not(:last-child)]:border-b sm:odd:[&:not(nth-last-2)]:border-b">
        <div>
          <span class="inline-flex rounded-lg bg-purple-50 p-3 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6">
              <path d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
          </span>
      ...
      <div class="group relative border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600 sm:even:border-l sm:even:[&:not(:last-child)]:border-b sm:odd:[&:not(nth-last-2)]:border-b">
        <div>
          <span class="inline-flex rounded-lg bg-sky-50 p-3 text-sky-700 dark:bg-sky-900/30 dark:text-sky-300">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6">
              <path d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
          </span>
      ...
      <div class="group relative border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600 sm:even:border-l sm:even:[&:not(:last-child)]:border-b sm:odd:[&:not(nth-last-2)]:border-b">
        <div>
          <span class="inline-flex rounded-lg bg-yellow-50 p-3 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-300">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6">
              <path d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
          </span>
      ...
      <div class="group relative border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600 sm:rounded-bl-lg sm:even:border-l sm:even:[&:not(:last-child)]:border-b sm:odd:[&:not(nth-last-2)]:border-b">
        <div>
          <span class="inline-flex rounded-lg bg-rose-50 p-3 text-rose-700 dark:bg-rose-900/30 dark:text-rose-300">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6">
              <path d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
          </span>
      ...
      <div class="group relative rounded-bl-lg rounded-br-lg border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600 sm:rounded-bl-none sm:even:border-l sm:even:[&:not(:last-child)]:border-b sm:odd:[&:not(nth-last-2)]:border-b">
        <div>
          <span class="inline-flex rounded-lg bg-indigo-50 p-3 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-300">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6">
              <path d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
          </span>
